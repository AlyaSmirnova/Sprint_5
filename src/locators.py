...
class StellarBurgersLocators:
    ...
    LOGIN_BUTTON = By.XPATH, "//button[text()='Войти']" #кнопка Войти" на странице регистрации
    ...
    LOGO = By.XPATH, "//svg[@src='http://www.w3.org/2000/svg']" #лого на странице Личного кабинета

    LOGOUT_BUTTON = By.XPATH, "//button[text()='Выход']" #кнопка "Выход" на странице Личного кабинет

    BUNS_SECTION = By.XPATH, "//span[text()='Булки']" #кнопка "Булки" на главной странице
    ACTIVE_BUNS_SECTION = By.XPATH, "//span[text()='Булки' and contains(@class, 'current')]"
    SAUCES_SECTION = By.XPATH, "//span[text()='Соусы']" #кнопка "Соусы" на главной странице
    ACTIVE_SAUCES_SECTION = By.XPATH, "//span[text()='Соусы' and contains(@class, 'current')]"
    ADDINGS_SECTION = By.XPATH, "//span[text()='Начинки']"  # кнопка "Начинки" на главной странице
    ACTIVE_ADDINGS_SECTION = By.XPATH, "//span[text()='Начинки' and contains(@class, 'current')]"
